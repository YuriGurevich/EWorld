...
ActiveRecord::Schema.define(:version => 20120807115637) do
  ...
  create_table "hotel_additional_services", :force => true do |t|
    t.string "name"
  end
  ...
  create_table "hotel_classifications", :force => true do |t|
    t.string "name"
  end
  ...
  create_table "hotel_rooms_type_types", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "hotel_rooms_types", :force => true do |t|
    t.string   "name"
    t.integer  "room_size"
  ...
  add_index "hotel_rooms_types", ["type_id"], :name => "index_hotel_rooms_types_on_type_id"
